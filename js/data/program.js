...
// Modified: extra leg volume on B/C/E days, kegel warmup on A/D, plateau detection support
...
const W1_B = [
  ...
  ex('Leg Press', 1, 3, '15', rpe(7), R.med, "Low/medium/high foot placement. LEGS FOCUS: drive through heels, feel quads stretch.", { tempo: '3-1-1', extra: 'legs' }),
...
const W1_E = [
  ...
  ex('Bulgarian Split Squat', 1, 3, '10/10', rpe(7), R.med, "LEGS FOCUS: rear foot elevated, knee tracks over toe. Feel the quad stretch at bottom.", { tempo: '3-1-1', extra: 'legs' }),
...
const W2_B = [
  ...
  ex('Leg Press', 1, 3, '15', rpe(7), R.med, "LEGS FOCUS: drive through heels, feel quads stretch at bottom.", { tempo: '3-1-1', extra: 'legs' }),
  ex('Arnold Press', 0, 3, '10', rpe(7), R.med, "Start elbows in front, palms in. Rotate palms forward as you press."),
  ex('Tricep Pressdown', 0, 3, '15', rpe(7), R.short, "Focus on squeezing your triceps to move the weight"),
  ex('Hex Bar / Smith Machine Shrug', 1, 3, '12', rpe(6), R.short, "Shrug up and in, pull shoulders up to ears!"),
];
...
const W2_E = [
  ...
  ex('Bulgarian Split Squat', 1, 3, '10/10', rpe(7), R.med, "LEGS FOCUS: rear foot elevated, knee tracks over toe. Full depth.", { tempo: '3-1-1', extra: 'legs' }),
  ex('Seated Hip Abduction', 1, 3, '20', rpe(7), R.short, "Focus on driving your knees out"),
...
const W3_B = [
  ...
  ex('Leg Press', 1, 3, '15', rpe(7), R.med, "LEGS FOCUS: drive through heels, feel quads stretch.", { tempo: '3-1-1', extra: 'legs' }),
  ex('Arnold Press', 0, 3, '10', rpe(7), R.med, "Start elbows in front, palms in. Rotate palms forward as you press."),
  ex('Tricep Pressdown', 0, 3, '15', rpe(7), R.short, "Focus on squeezing your triceps to move the weight"),
...
const W3_E = [
  ...
  ex('Cable Seated Row', 1, 3, '12', rpe(7), R.med, "Squeeze shoulder blades together, pull with elbows down and in"),
  ex('Bulgarian Split Squat', 1, 3, '10/10', rpe(8), R.med, "LEGS FOCUS: rear foot elevated, knee tracks over toe. Full depth.", { tempo: '3-1-1', extra: 'legs' }),
  ex('Seated Hip Abduction', 1, 3, '20', rpe(7), R.short, "Focus on driving your knees out"),
...
const W4_B = [
  ...
  ex('Leg Press', 1, 3, '15', rpe(8), R.med, "LEGS FOCUS: drive through heels, feel quads stretch.", { tempo: '3-1-1', extra: 'legs' }),
...
const W5_E = [
  ...
  ex('Bulgarian Split Squat', 1, 3, '10/10', rpe(7), R.med, "LEGS FOCUS: rear foot elevated. Full depth. Feel quad stretch.", { tempo: '3-1-1', extra: 'legs' }),
...
const W7_B = [
  ...
  ex('Leg Press', 1, 3, '15', rpe(7), R.med, "LEGS FOCUS: drive through heels, feel quads stretch.", { extra: 'legs' }),
...
const W7_E = [
  ...
  ex('Bulgarian Split Squat', 1, 3, '10/10', rpe(8), R.med, "LEGS FOCUS: rear foot elevated. Full depth. Feel quad stretch.", { extra: 'legs' }),
...
const W8_B = [
  ...
  ex('Barbell Hip Thrust or RDL', 2, 4, '12', rpe(8), R.med, "Hip thrust if glutes priority, RDL if hamstrings priority."),
  ex('Dumbbell Row', 1, 4, '12', rpe(8), R.med, "Pull the dumbbell to your hip"),
  ex('Leg Press', 1, 3, '15', rpe(8), R.med, "LEGS FOCUS: drive through heels, feel quads stretch.", { extra: 'legs' }),
  ex('Dumbbell Lateral Raise', 0, 4, '15', rpe(8), R.med, "Raise dumbbell out not up"),
...
const W8_E = [
  ...
  ex('Cable Lateral Raise', 1, 3, '8', rpe(8), R.short, "Swing the weight out, not up"),
  ex('Pendlay Row', 1, 4, '12', rpe(8), R.med, "Keep flat back, pull elbows back at 45°. Bar returns to floor each rep."),
  ex('Bulgarian Split Squat', 1, 3, '10/10', rpe(8), R.med, "LEGS FOCUS: rear foot elevated. Full depth. Peak effort.", { extra: 'legs' }),
  ex('Seated Hip Abduction', 1, 4, '20', rpe(8), R.short, "Focus on driving your knees out"),
  ex('EZ Bar Curl 21s', 1, 2, '10', rpe(8), R.short, "First 7 bottom half, next 7 top half, last 7 full ROM"),
  ex('Cable Crunch', 1, 4, '15', rpe(8), R.short, "Focus on flexing your spine. Avoid yanking with arms."),
  ex('Standing Calf Raise', 1, 4, '12', rpe(8), R.short, "1-2 second pause at the bottom"),
